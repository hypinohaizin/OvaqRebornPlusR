...
//    public static void rectOutline(MatrixStack matrices, double x, double y, double width, double height, int color, float thickness) {
//        rect(matrices, x, y, width, thickness, color);
//        rect(matrices, x, y + height - thickness, width, thickness, color);
//        rect(matrices, x, y + thickness, thickness, height - thickness * 2, color);
//        rect(matrices, x + width - thickness, y + thickness, thickness, height - thickness * 2, color);
//    }
