...
public class ShaderManager implements Globals
{
    ...
    public ShaderManager()
    {
        ...
        layerCreator = memoizeTexture(texture -> RenderLayer.of("ovaqrebornplus_overlay", VertexFormats.POSITION_TEXTURE_COLOR, VertexFormat.DrawMode.QUADS, 1536, RenderLayer.MultiPhaseParameters.builder()
    ...
    public void reloadShadersInternal()
    {
        ...
        filledShaderEffect = ShaderEffectManager.getInstance().manage(Identifier.of("ovaqrebornplus", "shaders/post/outline.json"));
        gradientShaderEffect = ShaderEffectManager.getInstance().manage(Identifier.of("ovaqrebornplus", "shaders/post/gradient.json"));
        imageShaderEffect = ShaderEffectManager.getInstance().manage(Identifier.of("ovaqrebornplus", "shaders/post/image.json"));
        glowingShaderEffect = ShaderEffectManager.getInstance().manage(Identifier.of("ovaqrebornplus", "shaders/post/glowing.json"));
        rainbowShaderEffect = ShaderEffectManager.getInstance().manage(Identifier.of("ovaqrebornplus", "shaders/post/rainbow.json"));
    }
