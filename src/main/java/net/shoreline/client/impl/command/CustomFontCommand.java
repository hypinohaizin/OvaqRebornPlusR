...
public class CustomFontCommand extends Command
{
    ...
    public void buildCommand(LiteralArgumentBuilder<CommandSource> builder)
    {
        builder.then(argument("font name", StringArgumentType.string()).executes(c ->
        {
            ...
            if (font.equalsIgnoreCase("hackgen") || font.equalsIgnoreCase("hackgen.ttf"))
            {
            ...
            String filePath = String.format("%s/%s", OvaqRebornPlus.CONFIG.getClientDirectory().toAbsolutePath(), fileName);
