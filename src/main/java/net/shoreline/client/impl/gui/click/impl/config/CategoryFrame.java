...
public class CategoryFrame extends Frame implements Serializable<CategoryFrame>
{
                         ...
                         float width, float height)
    {
        ...
        // this.categoryIcon = new Identifier("ovaqrebornplus", "icon/" + category.name().toLowerCase() + ".png");
    ...
    public void render(DrawContext context, float mouseX, float mouseY, float delta)
    {
        ...
        int moduleCount = Managers.MODULE.getCategoryModuleCount(category);
        String countText = "§7[§f" + moduleCount + "§7]";
        float countWidth = RenderManager.textWidth(countText) * ClickGuiModule.CLICK_GUI_SCALE;
        float textY = y + (4.0f * ClickGuiModule.CLICK_GUI_SCALE);

        drawStringScaled(context, name, x + (3.0f * ClickGuiModule.CLICK_GUI_SCALE), textY, whiteText);
        drawStringScaled(context, countText, x + (width * ClickGuiModule.CLICK_GUI_SCALE) - countWidth - (3.0f * ClickGuiModule.CLICK_GUI_SCALE), textY, whiteText);
