...
public class ModuleButton extends Button
{
                       ...
                       float mouseY, float delta)
    {
        ...
        float indX = ix + (width * ClickGuiModule.CLICK_GUI_SCALE) - RenderManager.textWidth(indicator) - (2.0f * ClickGuiModule.CLICK_GUI_SCALE);
        drawStringScaled(context, indicator, indX, iy + (3.5f * ClickGuiModule.CLICK_GUI_SCALE), colorText);
