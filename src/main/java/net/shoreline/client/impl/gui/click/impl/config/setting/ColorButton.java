...
public class ColorButton extends ConfigButton<Color>
{
                       ...
                       float mouseY, float delta)
    {
        ...
        if (pickerAnimation.getFactor() > 0.01f)
        {
            ...
            mc.getTextureManager().bindTexture(Identifier.of("ovaqrebornplus", "icon/sync_clickgui.png"));
            // RenderSystem.setShaderColor(1.0f, 1.0f, 1.0f, 1.0f);
            RenderSystem.setShaderTexture(0, Identifier.of("ovaqrebornplus", "icon/sync_clickgui.png"));
