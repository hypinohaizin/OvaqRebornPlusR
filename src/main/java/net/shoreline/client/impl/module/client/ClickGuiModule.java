...
public class ClickGuiModule extends ToggleModule
{
    ...
    //Config<Float> outlineWidthConfig = register(new NumberConfig<>("OutlineWidth", "Outline width", 1.0f, 1.0f, 5.0f));
    ...
    public void onEnable()
    {
        ...
        if (CLICK_GUI_SCREEN == null)
        {
            ...
            OvaqRebornPlus.CONFIG.loadClickGui();
        }
...
*/
    ...
    //    return outlineWidthConfig.getValue();
    //}
}
