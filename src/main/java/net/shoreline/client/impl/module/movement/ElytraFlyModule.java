...
public class ElytraFlyModule extends RotationModule
{
    ...
    {
        if (OvaqRebornPlusMod.isBaritonePresent() && BaritoneAPI.getProvider().getPrimaryBaritone().getPathingBehavior().isPathing())
        {
            return;
        }
        ...
        if (OvaqRebornPlusMod.isBaritonePresent() && obstaclePasserConfig.getValue())
        {
    ...
    {
        if (mc.player == null || OvaqRebornPlusMod.isBaritonePresent() && BaritoneAPI.getProvider().getPrimaryBaritone().getPathingBehavior().isPathing())
        {
            return;
        }
