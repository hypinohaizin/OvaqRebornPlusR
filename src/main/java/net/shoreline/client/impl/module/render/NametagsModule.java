...
public class NametagsModule extends ToggleModule
{
    ...
    //Config<Boolean> distanceConfig = register(new BooleanConfig("Distance", "Displays the distance to the player in meters", true));
...
//           String colorCode = PlayerUtil.getColoredDistance(player);
//
//           info.append(" ").append(colorCode).append(bd.doubleValue()).append("m").append(Formatting.RESET);
//        }
