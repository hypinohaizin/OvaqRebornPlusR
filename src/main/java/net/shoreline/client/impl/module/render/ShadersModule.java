...
public class ShadersModule extends ToggleModule
{
        ...
        for (Entity entity : mc.world.getEntities())
        {
            ...
            if (checkShaders(entity))
            {
                ...
                catch (Exception exception)
                {
                    ...
                    OvaqRebornPlus.error("Failed to render shader on entity!");
                }
            }
    ...
    /**
     * Loads the shader image from memory. The image is loaded from the OvaqRebornPlus folder.
     */
    private void loadShaderImage()
    {
        try
        {
            ...
            {
                File shaderFile = OvaqRebornPlus.CONFIG.getClientDirectory().resolve("shader." + fileFormat).toFile();
                ...
                {
                    Optional<Resource> optional = mc.getResourceManager().getResource(Identifier.of("ovaqrebornplus", "shaders/shader." + fileFormat));
