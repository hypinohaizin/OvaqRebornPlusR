...
{
    //
    public static final String PREFIX = Formatting.GRAY + "[" + Formatting.RESET + "§sOvaqRebornPlus" + Formatting.RESET + Formatting.GRAY + "] " + Formatting.RESET;
    ...
    {
        MessageIndicator messageIndicator = new MessageIndicator(ColorsModule.getInstance().getRGB(), null, Text.empty(), "ovaqrebornplus");
